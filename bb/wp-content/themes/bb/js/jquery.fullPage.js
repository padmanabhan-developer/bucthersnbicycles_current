...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.section').each(function(index){
			...
			if (numSlides > 0) {
				...
				$(this).find('.fp-slides').after('<div class="controlArrow prev"></div><div class="controlArrow next"></div>');
			...
			if( activeSlide.length &&  ($('.section.active').index('.section') != 0 || ($('.section.active').index('.section') == 0 && activeSlide.index() != 0))){
				...
				landscapeScroll($('.section.active').find('.fp-slides'), activeSlide);
		...
		*/		
        ...
        function marsStopPropagation(event) {
...
//            console.log('MouseWheelHandler ' + e.type);
//            console.log('targetId ' + e.target.getAttribute('id'));
//            console.log('targetClass ' + e.target.getAttribute('class'));
...
//            console.log('this ' + this);
				...
				if (!isMoving) { //if theres any #
					...
					if (delta < 0) {
						if(scrollable.length > 0 ){
							//is the scrollbar at the end of the scroll?
							if(isScrolled('bottom', scrollable)){
                                marsStopPropagation(e); // prevent padding after slide
                                $.fn.fullpage.moveSectionDown();
							}else{
		...
		function scrollPage(element, callback, isMovementUp){
            ...
            var bar = activeSection.find('.slimScrollBar');

            if (isMovementUp){
                scrollable.scrollTop(scrollable[0].scrollHeight - scrollable.height());
                bar.css('top',scrollable.height() - bar.height());
            } else {
		...
		$('.section').on('click', '.controlArrow', function() {
			...
			var slides = $(this).closest('.section').find('.fp-slides');
