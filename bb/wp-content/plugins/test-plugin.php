...
*/
	...
	function fwds_scripts() {
		...
		wp_register_script(
			'slidesjs_core', 
			plugins_url('js/jquery.slides.min.js', __FILE__),
			array("jquery"),
			'1.1.9',
			false
		);
		...
		wp_register_script(
			'slidesjs_init', 
			plugins_url('js/slidesjs.initialize.js', __FILE__),
			array('jquery', 'slidesjs_core'),
			'1.0',
			true
		);
	...
	function fwds_styles() 	{
		...
		wp_register_style(
			'slidesjs_example', 
			plugins_url('css/example.css', __FILE__)
		);
	...
	add_shortcode("my_advanced_shortcode", "my_advanced_shortcode_function");

	function my_advanced_shortcode_function($atts, $content = null)
	{
		extract(
			shortcode_atts(
				array(
